...
void _analyzeLayoutPatterns() {
    ...
    'analyzed_patterns': [
      {
        ...
        'flutter_code':
            'Container(width: 200, height: 100, child: Text("Hello"))',
        'frequency': 'high',
  ...
  _saveAnalysisResult('layout_patterns_analysis.json', {
    ...
    'conversion_notes':
        'Container → box, Column → linear(vertical), Row → linear(horizontal)'
  });
...
void _analyzeInputPatterns() {
  ...
  _saveAnalysisResult('input_patterns_analysis.json', {
    ...
    'conversion_notes':
        'TextFormField → textInput, ElevatedButton → button, Checkbox → checkbox'
  });
    ...
    'analyzed_patterns': [
      {
        ...
        'flutter_code':
            'ListView.builder(itemCount: items.length, itemBuilder: (context, index) => ListTile(...))',
        'frequency': 'very_high',
...
void _analyzeNavigationPatterns() {
    ...
    'analyzed_patterns': [
      {
        ...
        'flutter_code':
            'AppBar(title: Text("Home"), actions: [IconButton(...)])',
        'frequency': 'very_high',
      ...
      },
      {
        ...
        'flutter_code':
            'BottomNavigationBar(items: [...], onTap: (index) => ...)',
        'frequency': 'high',
  ...
  _saveAnalysisResult('navigation_patterns_analysis.json', {
    ...
    'conversion_notes':
        'AppBar → headerBar, BottomNavigationBar → bottomNavigation'
  });
...
void _analyzeCompleteApp() {
  ...
  _saveAnalysisResult('complete_app_analysis.json', {
    ...
    'migration_strategy':
        'Convert MaterialApp to application, Scaffold pages to page components'
  });
...
Map<String, dynamic> _convertLayoutPatternsToMcp(
...
Map<String, dynamic> _convertDisplayPatternsToMcp(
    Map<String, dynamic> analysis) {
  return {
...
Map<String, dynamic> _convertNavigationPatternsToMcp(
    Map<String, dynamic> analysis) {
  return {
