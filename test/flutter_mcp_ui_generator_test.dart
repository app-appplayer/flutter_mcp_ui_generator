...
void main() {
  group('Flutter MCP UI Generator - Complete Test Suite', () {
    ...
    group('MCPUIJsonGenerator - Layout Widgets', () {
      test('creates container with all properties', () {
    ...
    group('MCPUIJsonGenerator - Input Widgets', () {
      test('creates button', () {
        ...
        expect(button['onTap']['type'], 'tool');
        expect(button['style'], 'elevated');
      });

      test('creates textField', () {
        ...
        expect(textField['onChange']['type'], 'state');
      });
      ...
      test('creates switch', () {
        ...
        expect(switchWidget['onChange']['action'], 'toggle');
      });
    ...
    group('MCPUIJsonGenerator - Navigation Widgets', () {
      ...
      test('creates bottomNavigationBar', () {
      ...
      test('creates floatingActionButton', () {
        final fab = MCPUIJsonGenerator.floatingActionButton(
          onPressed: MCPUIJsonGenerator.toolAction('addItem'),
    ...
    group('MCPUIBuilder - Builders', () {
          ...
          .child(
            MCPUIBuilder.column()
              ...
              .add(MCPUIBuilder.row()
                ...
                .add(MCPUIJsonGenerator.button(
                  label: 'Submit',
                  onTap: MCPUIJsonGenerator.toolAction('submit'),
                ))
                .build())
              .build()
          )
      ...
      test('uses QuickBuilders', () {
        ...
        final iconButton = QuickBuilders.iconButton(
          label: 'Send',
          icon: 'send',
          onTap: MCPUIJsonGenerator.toolAction('send'),
        );
        ...
        expect(formField['type'], 'textfield');
                ...
                MCPUIBuilder.container()
                  ...
                  .child(
                    MCPUIBuilder.column()
                      ...
                      .add(MCPUIJsonGenerator.textField(
                        label: 'Email',
                        value: '{{email}}',
                        onChange: MCPUIJsonGenerator.stateAction(
                          action: 'set',
